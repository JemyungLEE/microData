...
DistEmissionFile = Base.source_dir() * "/data/emission/2011_IND_hhs_emission_cat_"*tag*".txt"
...
if incomeMode
    ...
    eData = ec.categorizeHouseholdByIncome(year,intervals,normMode,squareRoot=eqvalMode,absintv=absint,percap=percapita)
